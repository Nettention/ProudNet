...
// Please refer MSDN for the newest information of specific value that using at other platform.
...
#define _WIN32_WINDOWS 0x0410 // Please check reasonable value for suitalbe with Windows Me or higher.
#endif

#ifndef _WIN32_IE                       // Assign Internet Explorer 7.0 as minimum required platform.
#define _WIN32_IE 0x0700        // Please check reasonable value for suitalbe with other version of IE.
#endif
